        ...
        implements Closeable
{
    ...
    public static TDOperator fromConfigWithRetries(Config config) {
        return fromConfig(config, true);
    }

    public static TDOperator fromConfig(Config config, boolean retries)
    {
        ...
        TDClient client = TDClientFactory.clientFromConfig(config, retries);
